Write-Host "Visual-Studio-Install.ps1 module called..." -ForegroundColor "Red"
...
function Install-Product
{
    ...
    $args = "/Quiet /NoRestart /AdminFile $adminDeployment /Log $Env:Temp\VisualStudio2017_Install.log"
