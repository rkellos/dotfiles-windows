Write-Host "SetupSonarQube.ps1 module called..." -ForegroundColor "Red"
...
$source = "C:\Temp\SonarQube-7.1.zip"
...
{
	Install-JavaRuntimeEnvironment "C:\temp\jre-8u60-windows-x64.exe" -Verbose:$RunAsVerboseSession
}
...
Install-SonarQubeService -SonarSource (Join-Path $installFolder sonarqube-7.1) -Verbose:$RunAsVerboseSession
