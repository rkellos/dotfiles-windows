...
${function:cd-dt} = { Set-Location ~\Desktop }
${function:cd-docs} = { Set-Location ~\Documents }
${function:cd-dl} = { Set-Location ~\Downloads }

${function:cd-dev} = { Set-Location ~\dev }
${function:cd-temp} = { Set-Location ~\temp }
${function:cd-utils} = { Set-Location ~\utils }
